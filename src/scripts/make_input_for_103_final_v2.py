...
def make_batches(samples, mean, std, gmean, gstd, uttid):
...
#            fdic[spk][tone]["fp"] = hdf
    ...
    for i in range(len(idxs)):
        ...
        batches = make_batches(samples, mean, std, gmean, gstd, uttid)
        if len(batches) == 0:
            spkdic[spk] += 1
            continue
...
vad = "/disk2/pwj/workspace/pitch-range/src/103_after_vad"
des = "/disk2/pwj/workspace/pitch-range/src/model/103_input_final_v2/"
