...
def model_evaluate(train, dev, test,  batch_size, skip_steps, num_steps, input_dim, fmd, op):
    ...
    mape = md.evaluate(testX, testY, batch_size = 50)
#    mape = evaluate_manually(md, testX, testY, test_spe, "./test.out")
    print("The mape manually calculated is {}".format(mape))
